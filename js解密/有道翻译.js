...
// var e ='中国';
// var er = '16112858739354';

// word = "fanyideskweb中国↵16112858739354Tbh5E8=q6U3EXe+&L[4c@";
// word = "fanyideskweb中国↵16112862806003Tbh5E8=q6U3EXe+&L[4c@"


var get_translation = function(word){
    var t = md5("5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Mobile Safari/537.36")
        , r = "" + (new Date).getTime()
        , ii = r + parseInt(10 * Math.random(), 10);

    var word = "fanyideskweb" + word + ii + "Tbh5E8=q6U3EXe+&L[4c@";
    var data = md5(word);
    console.log(data);
}
