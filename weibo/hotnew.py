...
cookies = {
    ...
    "WBPSESS": "Dt2hbAUaXfkVprjyrAZT_GdR2dzE8Cl64yGlfs90oQYjc7UKgVK05F8ZbERpfJWflT8FveVTMqJooz88U_V6xXuqbhkMeQMzMJyc3hB8woYkOhEql3WRF3TRJG9LWJt3TJ_sorylFlj8FQXdjtBJdQ=="
}
max_id = 0 
...
while True:
    ...
    data = response.json()
    for item_data in data["statuses"]:
        print(item_data["source"],item_data["text"])

    file = open(f"hotnew/{max_id}.json","w",encoding = "utf-8")
