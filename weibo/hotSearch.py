...
cookies = {
    ...
    "WBPSESS": "Dt2hbAUaXfkVprjyrAZT_GdR2dzE8Cl64yGlfs90oQYjc7UKgVK05F8ZbERpfJWflT8FveVTMqJooz88U_V6xeA2Zm4MuIPrdFUkAQOcHiqd-PmZvMfyxFdfe7QUEgTDkoeSbnrxR9dgJ70ZVwmiyQ=="
}
url = "https://weibo.com/ajax/side/hotSearch"

url ="https://weibo.com/ajax/statuses/entertainmen"
...
for item in data["data"]["realtime"]:
    # print(item["word_scheme"],item["num"])
    print(item)
with open("hotSearch.toml","w",encoding= "utf-8") as f:
    f.write(json.dumps(data["data"]["realtime"],indent =4,ensure_ascii=False))
