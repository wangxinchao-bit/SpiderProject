...
headers = {
    ...
    "referer": "https://weibo.com/newlogin?tabtype=entertainment&gid=&openLoginLayer=0&url=https%3A%2F%2Fweibo.com%2F",
...
cookies = {
    ...
    "WBPSESS": "Dt2hbAUaXfkVprjyrAZT_GdR2dzE8Cl64yGlfs90oQYjc7UKgVK05F8ZbERpfJWflT8FveVTMqJooz88U_V6xa4kVMJxisCC5N17MXI4jCh1vyDV7XYfAXLbyJyMZZybtHupQ3VWGHejud59u6dIeA=="
}
...
print(response.text)
data = response.json()
with open("hotentainment.toml","w",encoding= "utf-8") as f:
