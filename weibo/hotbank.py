...
headers = {
    ...
    "referer": "https://weibo.com/newlogin?tabtype=list&gid=1028038899&openLoginLayer=0&url=https%3A%2F%2Fweibo.com%2F",
...
cookies = {
    ...
    "WBPSESS": "Dt2hbAUaXfkVprjyrAZT_GdR2dzE8Cl64yGlfs90oQYjc7UKgVK05F8ZbERpfJWflT8FveVTMqJooz88U_V6xR_-pw3acvH0udn_KxHm9Lpc9Q_vjOAixTSYS30VlqP9Dw_te_ymxUTym2cp84Aj7w=="
}
...
while True:
    ...
    params = {
        "since_id": "0",
        "refresh": "1",
        "group_id": "102803"+str(num),
        "containerid": f"102803_ctg1_{num}_-_ctg1_{num}",
