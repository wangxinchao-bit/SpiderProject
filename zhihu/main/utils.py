...
with open('js/X_Zst81.js', 'r', encoding='utf-8') as f:
    js_code = f.read()
...
def following_x_zse_96(api,cookie_dc_2,js_81):
...
def vote_xzst_96(api,cookie_dc_2,data,js_81):
    tt_codes = '101_3_3.0'+"+"+api+"+"+cookie_dc_2 +"+"+data+"+"+ js_81
    hl = hashlib.md5()
    hl.update(tt_codes.encode(encoding='utf-8'))
    res_md5 = hl.hexdigest()
    result = ctx_96.call('func', res_md5)
