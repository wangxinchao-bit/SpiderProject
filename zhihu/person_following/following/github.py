...
def user_followees(page_N):
    ...
    uh = "/api/v4/members/"+url_token+"/followees?include=data%5B*%5D.answer_count%2Carticles_count%2Cgender%2Cfollower_count%2Cis_followed%2Cis_following%2Cbadge%5B%3F%28type%3Dbest_answerer%29%5D.topics&offset="+str(offset)+"&limit=20"
    tf = ta+'+'+uh+'+'+cookie_dc0
    ...
    url = "https://www.zhihu.com/api/v4/members/"+url_token+"/followees?include=data%5B*%5D.answer_count%2Carticles_count%2Cgender%2Cfollower_count%2Cis_followed%2Cis_following%2Cbadge%5B%3F%28type%3Dbest_answerer%29%5D.topics&offset="+str(offset)+"&limit=20"
